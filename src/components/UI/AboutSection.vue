      ...
      <v-col cols="12" md="6">
        <div class="pa-5">
          ...
          <p>
            ...
            it's a gateway to a world of joy and satisfaction. Join us on this
            delicious journey and explore a wide array of recipies, opinions,
            tips, and suggestions. Let us inspire you to create mouthwatering
